...
function Gap() { return <div style={{ height: 12 }} />; }
    ...
    >
      ...
      <div className="terminal-body p-5 flex flex-col gap-3">
        ...
        <Row label="Ken.contactInfo">
          ...
          <a className="underline" style={{ color: T.link }} href="mailto:knnthgms@gmail.com">knnthgms@gmail.com</a>
          <span style={{ color: T.amber }}>&quot;</span>
          <span style={{ color: T.muted }}>, </span>
          <span style={{ color: T.amber }}>&quot;</span>
          <a className="underline" style={{ color: T.link }} href="https://linkedin.com/in/knnthgms" target="_blank" rel="noopener noreferrer">LinkedIn</a>
          <span style={{ color: T.amber }}>&quot;</span>
          <span style={{ color: T.muted }}>, </span>
          <span style={{ color: T.amber }}>&quot;</span>
          <a className="underline" style={{ color: T.link }} href="https://github.com/knnthgms" target="_blank" rel="noopener noreferrer">Github</a>
          <span style={{ color: T.amber }}>&quot;</span>
          <span style={{ color: T.bracket }}>]</span>
        </Row>
        ...
        <Row label="Ken.resume">
          <span style={{ color: T.amber }}>&quot;</span>
          <a className="underline" style={{ color: T.link }} href="/assets/KENNETH_GOMES_CV.pdf" target="_blank" rel="noopener noreferrer">ken_gomes_resume.pdf</a>
          <span style={{ color: T.amber }}>&quot;</span>
        </Row>
